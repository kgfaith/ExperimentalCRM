            ...
            var places = new List<Place>
                             {
                                 ...
                                 new Place{ PlaceName = "Yangon", Description = "Description of Yangon city", PlaceType = placeTypes[2], PlaceId = placeTypes[2].PlaceTypeId, InternalRanking = 1, ParentStateId = 5},
                                 ...
                                 new Place{ PlaceName = "CityTown1", Description = "Description of taungyi", PlaceType = placeTypes[2], PlaceId = placeTypes[2].PlaceTypeId, InternalRanking = 1, ParentStateId = 5},
                                 new Place{ PlaceName = "CityTown2", Description = "Description of taungyi", PlaceType = placeTypes[2], PlaceId = placeTypes[2].PlaceTypeId, InternalRanking = 1, ParentStateId = 5},
                                 new Place{ PlaceName = "CityTown3", Description = "Description of taungyi", PlaceType = placeTypes[2], PlaceId = placeTypes[2].PlaceTypeId, InternalRanking = 1, ParentStateId = 5},
                                 new Place{ PlaceName = "CityTown4", Description = "Description of taungyi", PlaceType = placeTypes[2], PlaceId = placeTypes[2].PlaceTypeId, InternalRanking = 1, ParentStateId = 5},
                                 new Place{ PlaceName = "CityTown5", Description = "Description of taungyi", PlaceType = placeTypes[2], PlaceId = placeTypes[2].PlaceTypeId, InternalRanking = 1, ParentStateId = 5},
